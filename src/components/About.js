function About() {
      return (
        <div className="mt-16 p-6 bg-[#e9e5dc] shadow-md rounded-lg">
          ...
          <p className="mt-4">Over 15 years in logistics and administration at major multinational 
              firms introduced me to the advanced use of Microsoft Office, particularly for process optimization. 
              That exposure sparked a growing interest in coding with VBA and SQL, enabling me to design custom 
              ...
              solutions—learning from it (or perhaps learning with it!).Drawing on my 
