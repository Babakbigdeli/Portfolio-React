...
let SampleProjects = [
  ...
  },
  {
    ...
    description: " A web application that helps you choose the perfect food and movie combination. Javascript, HTML, CSS, Bulma, Jquery was used to make this application",
